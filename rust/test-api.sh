...
curl -s http://127.0.0.1:8080/api/multisig-p2sh-address -d '{"pub_keys": ["1MdnhGkQ5QNuG3LWfGzuh58AXX8T3XC2sS"], "n": 2}' | jq
echo -e '\nMultiSig P2SH bad request 2'
curl -s http://127.0.0.1:8080/api/multisig-p2sh-address -d '{"pub_keys": ["1LqEjz7JefSCJfrhb1ga9KLZmh81iw2QCw", "12W9StPbvenVra5oMmvGxEkJvgTqC6EcYV"], "n": 3}' | jq
echo -e '\nMultiSig P2SH good request'
curl -s http://127.0.0.1:8080/api/multisig-p2sh-address -d '{"pub_keys": ["1LqEjz7JefSCJfrhb1ga9KLZmh81iw2QCw", "12W9StPbvenVra5oMmvGxEkJvgTqC6EcYV", "1MdnhGkQ5QNuG3LWfGzuh58AXX8T3XC2sS"], "n": 2}' | jq
